-- Update ticket settlement flow according to new requirements
-- Remove separate Settlements field and add payment status with checkbox validation
...
WHERE settlement_status = 'paid' AND settlement_timestamp IS NOT NULL;
...
-- 8. Update RLS policies if needed (existing policies should cover these new fields)
